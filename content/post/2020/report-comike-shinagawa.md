...
通りからビル群へ入って、道なりに進むと、りんかい線 品川シーサイド駅のエレベーター口に到着です。なお、エレベーター口にはエレベーターしかありませんので、階段・エレベーターを使いたい方や混雑時は、A・BC口を使うことをおすすめします。左右どちら側にも入り口があります。元からA・BC口を使う想定の場合は、イオン前の庭園からビル群の道を通るように行くと便利です。
